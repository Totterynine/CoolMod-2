...
CVGUIMapaddEditor_Properties::CVGUIMapaddEditor_Properties( Panel *pParent )
	: BaseClass( pParent, "MapaddEditorProperties" )
{
	SetMinimumSize( 300, 100 );
	SetPropertyMode( PROPERTYMODE_ENTITY );
	...
	LoadControlSettings( "resource/mapadd/editor_properties.res" );
...
CVGUIMapaddEditor_Properties::~CVGUIMapaddEditor_Properties()
{
	FlushProperties();
}

CVGUIMapaddEditor_Properties::PROPERTYMODE CVGUIMapaddEditor_Properties::GetPropertyMode()
{
	return m_iPropMode;
}

void CVGUIMapaddEditor_Properties::OnRequestPropertyLayout( PROPERTYMODE mode )
{
...
void CVGUIMapaddEditor_Properties::SetPropertyMode( PROPERTYMODE mode )
{
	m_iPropMode = mode;
}

void CVGUIMapaddEditor_Properties::OnSizeChanged( int newWide, int newTall )
{
...
void CVGUIMapaddEditor_Properties::PerformLayout()
{
	BaseClass::PerformLayout();
}

void CVGUIMapaddEditor_Properties::FlushProperties()
{
	m_pListRoot->RemoveAll();
	m_hProperties.PurgeAndDeleteElements();
}

void CVGUIMapaddEditor_Properties::CreateProperties()
{
	FlushProperties();

	CreateProperties_Entity();
...
void CVGUIMapaddEditor_Properties::OnPropertyChanged( Panel *panel )
{
	PropertyClient *pActivator = dynamic_cast< PropertyClient* >( panel );
	Assert( pActivator != NULL );

	KeyValues *pChangeValues = new KeyValues("entity");
	...
	CMapaddEditor *pEditor = GetMapaddEditor();
...
void CVGUIMapaddEditor_Properties::OnFileLoaded()
{
	RefreshGlobalLightData();
}

void CVGUIMapaddEditor_Properties::RefreshGlobalLightData()
{
}

void CVGUIMapaddEditor_Properties::OnLightSelectionChanged()
{
	OnRequestPropertyLayout( PROPERTYMODE_ENTITY );
...
void CVGUIMapaddEditor_Properties::SendPropertiesToRoot()
{
...
void CVGUIMapaddEditor_Properties::CreateProperties_Entity()
{
	...
	pTextEntry = new PropertyTextEntry(
		MakeKey("classname", "npc_metropolice"),
		PropertyTextEntry::PTENTRY_STRING, true);
	pTextEntry->SetLabelName("Classname");
	m_hProperties.AddToTail(pTextEntry);

	pTextEntry = new PropertyTextEntry(
		MakeKey( "origin", "0 0 0" ),
		PropertyTextEntry::PTENTRY_STRING, true );
...
void CVGUIMapaddEditor_Properties::UpdatePropertyVisibility()
{
...
void CVGUIMapaddEditor_Properties::AddPropertyToList( Panel *panel )
{
...
void CVGUIMapaddEditor_Properties::PropertiesReadAll()
{
	for ( int i = 0; i < m_hProperties.Count(); i++ )
	{
		PropertyClient *pClient = dynamic_cast< PropertyClient* >( m_hProperties[ i ] );
...
KeyValues *CVGUIMapaddEditor_Properties::AllocKVFromVisible()
{
